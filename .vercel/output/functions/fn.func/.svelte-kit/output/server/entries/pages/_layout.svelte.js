import { c as create_ssr_component, b as compute_rest_props, a as setContext, d as spread, e as escape_object, f as escape_attribute_value, g as add_attribute, i as is_void, n as noop, h as getContext, j as escape, v as validate_component } from "../../chunks/index.js";
...
${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<img src="${"/images/dht32b.svg"}" class="${"mr-3 h-6 sm:h-9"}" alt="${"Downhole Testing Logo"}">
	  <span class="${"self-center whitespace-nowrap text-xl font-semibold dark:text-white"}">Downhole Testing
	  </span>`;
        }
      })}
	...
	${validate_component(NavUl, "NavUl").$$render($$result, { hidden }, {}, {
	  ...
	  ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/tech" }, {}, {
            default: () => {
...
<footer class="${"footer items-center p-4 bg-neutral text-neutral-content"}"><div class="${"flex flex-row justify-around"}"><p></p>
	 <p class="${"text-center"}">© 2023 : Downhole Testing Ltd - All rights reserved
	</p>
